package com.Misbra.Authentication.Config;

import com.Misbra.Authentication.Filter.JwtFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:3000","https://www.misbar.games","https://misbar.games","misbar.games")); // Allow frontend origin
